...
export default function FeaturedSideArticle({article}: FeaturedSideBarProps) {
    return(
        ...
        <div className="flex size-full rounded-lg border shadow-md hover:bg-gray-100 dark:border-gray-700 dark:hover:bg-gray-700">
                    <img className="w-24 rounded-l-lg object-cover sm:w-32 lg:w-52" src={article.headerImage.url}/>
                    <div className="w-full overflow-hidden px-4 py-2 sm:p-4 ">
                        <h2 className=" mb-2 line-clamp-2 h-12 overflow-hidden font-bold sm:line-clamp-3 sm:h-[90px] sm:text-xl lg:line-clamp-4 lg:h-32 lg:text-2xl">{article.title}</h2>
