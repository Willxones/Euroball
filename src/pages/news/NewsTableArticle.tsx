...
export function NewsTableArticle({
  article,
}: {
  ...
  if (!article) {
    return (
      <div className="text-center dark:text-white">Error Fetching Article</div>
    );
  }
  return (
    <>
      <a href={`/article/${article.sys.id}`}>
        <div className="h-[400px] w-full cursor-pointer rounded-lg shadow-md hover:shadow-xl dark:border dark:border-gray-700 dark:text-white sm:h-[500px] lg:max-w-sm">
          <img
            ...
            className="h-52 w-full rounded-t-lg object-cover object-center sm:h-72"
          />
          <div className=" p-5">
