...
export default function Standings() {
  ...
  const {
    ...
    data: dataDivisions,
  } = useQuery(GET_DIVISIONS_BY_LEAGUE, {
  ...
  return (
    <>
      ...
      {selectedLeague &&
        ...
        !errorDivisions &&
        dataDivisions &&
        dataDivisions.divisionCollection.items.length === 0 && (
          <div className="py-12 text-center text-gray-800 dark:text-white">
            Sorry, there are no standings available for this league
          </div>
        )}
      {dataDivisions &&
        dataDivisions.divisionCollection.items.length > 0 &&
        dataDivisions.divisionCollection.items.map(
